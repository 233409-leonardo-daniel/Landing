...
const razaCards = [
  ...
  },
  {
    ...
    character: 'Elfos',
    text: 'La raza mas longeva y sabia de la tierra media recluida lejos de las demas razas.',
    btn: 'Click para ver'
  },
  {
    image: 'images.jpeg',
    character: 'Magos',
    text: 'La raza mas enigmatica con solo tres miembros y de un gran poder.',
    btn: 'Click para ver'
  },
  {
    image: 'images (1).jpeg',
...
const peliculaCards = [
  ...
  },
  {
    ...
    character: 'El Señor de los anillos la comunidad del anillo',
    text: 'En la Tierra Media, un joven hobbit llamado Frodo Bolsón hereda un anillo con el poder de dominar a todos los seres. Con la ayuda de una comunidad formada por humanos, elfos, enanos y otros hobbits, Frodo emprende un peligroso viaje para destruir el anillo en el Monte del Destino y evitar que el oscuro señor Sauron recupere su poder.',
    btn: 'Click para ver'
  },
  {
...
const Home = () => (
  <>
    ...
    <div className="bg-orange-300 min-h-screen p-6">
      <div className="mb-6 border-2 border-orange-800 p-4 bg-orange-400">
        <p className="text-2xl text-center font-bold mb-4 bg-amber-800">Razas</p>
        <CardList type="razas" cards={razaCards} />
      </div>
      <div className="mb-6 border-2 border-orange-800 p-4 bg-orange-400">
        <p className="text-2xl text-center font-bold mb-4 bg-amber-800">Películas</p>
